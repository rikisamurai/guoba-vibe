...
| [`apps/deep-link-lab`](apps/deep-link-lab) | 本地 deep link 编译与环境矩阵工作台，支持安全导入导出与多环境预览           | React 19 · Vite 8 · Vitest                                                                                |
...
│   ├── deep-link-lab/ # Deep link 编译与环境矩阵
