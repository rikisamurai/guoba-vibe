...
| [`apps/screenshot-qa-board`](apps/screenshot-qa-board) | 本地截图 QA 工作台，持久化前后对比、问题状态与验收清单                      | React 19 · Vite 8 · Vitest                                                                                |
...
│   ├── screenshot-qa-board/ # 截图对比与视觉 QA 工作台
